...
scl=1
scl1=26
killtimer=0 #GUI shutdown command
actnum=0
counterMax=360
...
# defs
    ...
    #def set_stream(self,dev): 
        ...
        #self.send_msg(dev,0x41, 0x3C, 0, 0, '\x01\x00')              # 0x3c = 60 Set operation mode    0x0001
        #return
